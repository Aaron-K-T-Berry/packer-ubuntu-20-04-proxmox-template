...
variable "memory" {
  type        = number
  default     = 2048
  description = "RAM in MiB. Ubuntu 20.04 live-server autoinstall needs about 2G"
}
...
variable "iso" {
  type        = string
  description = "ISO already present on the PVE node, for example local:iso/ubuntu-20.04.6-live-server-amd64.iso"
}
